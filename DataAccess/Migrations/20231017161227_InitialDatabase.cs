...
namespace DataAccess.Migrations
{
    ...
    public partial class InitialDatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Email", "FirstName", "HireDate", "LastName", "MiddleName", "Password", "PubId", "RoleId", "Source" },
                values: new object[,]
                {
                    { 1, "admin1@gmail.com", "Nguyen", new DateTime(2023, 10, 17, 23, 12, 27, 314, DateTimeKind.Local).AddTicks(2711), "Quyet", "Huu", "admin123456", 1, 1, "123" },
                    { 2, "user1@gmail.com", "Nguyen", new DateTime(2023, 10, 17, 23, 12, 27, 314, DateTimeKind.Local).AddTicks(2722), "Quyet2", "Huu2", "user123456", 2, 2, "ok" }
                });
